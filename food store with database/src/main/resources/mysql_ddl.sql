...
insert into food(name, cost, src, bargain) values("Staple1", 1.0, "/images/staple-1.png", false);

insert into food(name, cost, src, bargain) values("Staple2", 2.0, "/images/staple-2.png", true);
